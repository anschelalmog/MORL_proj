"""Replay buffer for multi-objective reinforcement learning with scalarization weights."""
...
class ReplayBuffer:
    """Multi-objective replay buffer for multi-objective reinforcement learning with scalarization weights."""
    ...
    def add(self, obs, action, reward, next_obs, done, weight):
        ...
        Args:
            ...
            weight: Scalarization weight vector
        """
        ...
        self.weights[self.ptr] = np.array(weight).copy()
    ...
    def sample(self, batch_size, replace=True, use_cer=False, to_tensor=False, device=None):
        ...
        Returns:
            A tuple of (observations, actions, rewards, next observations, dones, weights)
